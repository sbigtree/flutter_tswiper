...
import 'package:flutter_tswiper/flutter_tswiper.dart';
import 'package:flutter_tswiper/src/transform_page_view/index_controller.dart';
export 'package:flutter_tswiper/src/transform_page_view/index_controller.dart';
import 'dart:async';
...
abstract class SwiperTimerMixin extends State<Swiper>
  ...
  bool _autoplayEnabled() {
    return controller.autoplay ?? widget.autoplay;
  }
...
class SwiperState extends SwiperTimerMixin {
  int _activeIndex;
  int test;
...
//        print('_pageController---addListener--->${_pageController.page}');
      });
...
//    print('_activeIndex2---$_activeIndex');

  }

  void _onIndexChanged(int index) {
//    _controller.index = index;
//    print('_onIndexChanged--$index');
//    setState(() {
//      _activeIndex = index;
////
//    });
...
//    print('_pageController._isPageViewLayout---${_isPageViewLayout()}');
...
//            print('_pageController.page---${controller.indexIsChanging}');
...
//                _activeIndex = _controller.index;
              ...
              controller.index = _pageController.page.floor();

              controller.offset =
                  (_pageController.page - controller.index).clamp(-1.0, 1.0);
//              print('_controller.value---${controller.animation.value}');
        ...
        return new NotificationListener(
          child: child,
          onNotification: (ScrollNotification notification) {
//            print('_pageController.page---${_controller.indexIsChanging}');
            if (notification is ScrollStartNotification) {
            } else if (notification is ScrollUpdateNotification &&
                !controller.indexIsChanging) {
//              _pageController
...
//                _activeIndex = _controller.index;
              ...
              controller.offset =
                  (_pageController.page - controller.index).clamp(-1.0, 1.0);
//              print('NotificationListener_pageController.page---${_pageController.page} | ${controller.index}');
...
//    print('_ensureConfig--_pageController--->${_pageController.page}');
    if (config == null) {
