...
class ExampleHorizontal extends StatelessWidget {
  GlobalKey swiperkey = GlobalKey<SwiperState>();
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[ Builder(builder: (c){
            return  IconButton(icon: Icon(Icons.navigate_next), onPressed: (
            ){
//              context.findAncestorStateOfType<SwiperState>().;
            ...
            return Column(children: <Widget>[
              ...
              Builder(builder: (c){
                return  IconButton(icon: Icon(Icons.navigate_next), onPressed: (
                  ...
                  context.findAncestorStateOfType<SwiperState>().controller.next();
